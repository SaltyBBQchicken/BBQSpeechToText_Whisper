...
---   Author's note. 
I wrote this simple program because I do not want my voice recording spread across the internet.
I also included a firewall "..FirewallRules/AddFirewallRules.bat"  which contains a bat file that will add a block for inbound and outbound traffic to Windows Defender for this program. 
